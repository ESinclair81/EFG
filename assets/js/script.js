...
var settings = {
    ...
    function clickmovie(id){
        var showTimes = {
            "url": "https://api-gate2.movieglu.com/filmShowTimes/?film_id=" + id + "&date=2020-10-24&n=5",
            "method": "GET",
            "timeout": 0,
            "datatype": "JSON",
            "headers": {
           ...
           $.ajax(showTimes).done(function(response){
            ...
            // var showTimeEl = document.createElement("a");
            // showTimeEl.classList = "content";

            // var timeEl = document.createElement("span");
            // timeEl.textContent = cinemaTimes;
        
    
            for(i = 0; i < cinemas.length; ++i) {

                // var cinemaTimes = cinemas[i].showings.Standard.times[0].start_time


                // timeEl.append(cinemaTimes);
                // showTimeEl.append(timeEl);
...
//   getLocation();
  ...
  var nearBy = {
    ...
    "headers": {
    "api-version": "v200",
    "Authorization": "Basic U0NIT18yODpBaVlDa0VmMDRtMXQ= ",
    "client": "SCHO_28 ",
    "x-api-key": "mBt5WKzcOk2mIJmnS3rAPauB06sUZSEr2qayBme6 ",
    "device-datetime": "2020-10-25T07:47:57",
    "territory": "CA",
    "geolocation":"-79.38; 43.65",
